...
class RenewBookInstancesViewTest(TestCase):
    ...
    """Je crois que cette fonction ne fonctionne pas car je n'ai pas dû faire la partie mais je ne suis pas sûre.
   def test_redirect_if_not_logged_in(self):
    ...
    """
    #The all-borrowed view was added as a challenge (que je n'ai pas fait je crois, ça redirigeait vers la home page)
...
class AuthorCreateTest(TestCase):
    ...
    #Fonction self to create des trucs initiaux je pense
    ...
    #Test initial date
    def test_form_Died_initially_has_date_11062020(self):
        #login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}))
        self.assertEqual(response.status_code, 200)
